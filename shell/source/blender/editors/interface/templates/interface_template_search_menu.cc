    ...
    break
      ...
      if (area != nullptr) {
        ...
        switch (eSpace_Type(area->spacetype)) {
          ...
          SPACE_MENU_NOP(SPACE_CADEX_CHAT);
          SPACE_MENU_NOP(SPACE_CADEX_PARAMS);
          SPACE_MENU_NOP(SPACE_CADEX_ENV);
          SPACE_MENU_NOP(SPACE_CADEX_POLICY);
          SPACE_MENU_NOP(SPACE_CADEX_TRAINING);
          SPACE_MENU_NOP(SPACE_CADEX_LIVE);
          SPACE_MENU_NOP(SPACE_CADEX_BLUEPRINT);
        }
      }
