...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Tally removal, placement guidance and ADR-244 worker repair are qualified. Bounded dependency discovery completed and stopped at cold identity and occurrence ambiguity, without diagnostic implementation. Short retains only one eligible two-servo walk to measure fresh agent compliance. The controller must not repeat the pre-reset administrative dispatch. General worker races and the historical source writer remain unknown, and swept review expansion stays unselected [rec: windy-dune-3488] [rec: misty-tide-6394] [rec: lawful-dune-3795] [rec: early-gate-3510] [rec: chilly-spark-3931] [rec: clear-crest-9910].
