...
1. **Both selected units landed (missions 2/6).** The guide now distinguishes child reward/delta rows from the successful walk review row; the iterate block is 16 lines shorter and retains the runnable command, baseline, reward decrease and limits. Each unit passed 223 CLI tests without skips. Neither remains dispatchable [rec: still-harvest-7242] [rec: floral-canyon-9424].
2. **No next actor unit is selected.** Standing lifecycle maintenance is the chosen direction, but no concrete failure or contradiction remains from these units. Do not dispatch an audit, repeated green walk, hold record, provider probe or further generic prose cleanup. A new evidenced defect in the authorized scope requires a fresh bounded planning decision. This empty dispatch is not a state-gap retirement or a claim that the controller has stopped [rec: sharp-garden-2483].
3. **Scope and budget.** All four seeded criteria remain working in state; charter boxes remain human-owned. The latest full iterate supplies the empty-rung rehearsal evidence. Signals: 9 iterations, 3.8h elapsed, 44.2h left; Claude seven_day 62%, five_hour 100%, Codex seven_day 66%. Remaining budget does not promote Later criteria and no clock gate applies [rec: mellow-quartz-8093] [rec: frosty-wolf-4770] [rec: sharp-garden-2483].
