...
"""A headless Chromium driven over its DevTools pipe, for review capture and tests.
...
Playwright cache); tests skip when there is none; video capture reports a missing prerequisite.
