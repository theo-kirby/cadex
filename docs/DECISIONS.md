...
**And once more (2026-08-05).** Two branches each wrote an ADR-123 the same
day. The organic-modelling run kept the number, because ADR-123…130 are cited
by name in `shell/` and in four docs; the other entry — the position
actuator's command range — moved to **ADR-131**, cited nowhere but itself.
Its commit, `57be248a`, still says ADR-123.
