...
int main(int argc, char** argv)
{
    ...
    App::Application::Config()["ExeName"] = "cadex";
    App::Application::Config()["ExeVendor"] = "cadex";
    App::Application::Config()["AppDataSkipVendor"] = "true";
    App::Application::Config()["MaintainerUrl"] = "https://github.com/10-X-eng/cadex";

    // set the banner (for logging and console)
    App::Application::Config()["CopyrightInfo"] = sBanner;
    App::Application::Config()["AppIcon"] = "cadex";
    App::Application::Config()["SplashScreen"] = "cadexsplash";
