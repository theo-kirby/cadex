...
2. **Standing lifecycle maintenance (missions 1/2/6).** CPU setup, shared regressions, recovery and offline remote preflight are delivered. The bounding-box motion screen was retired after measurement; rollout travel reporting and comparison replaced it and have landed. Retention and comparison identity are delivered. The fixed-geometry seed-0 reference and offline resumed-context regression are delivered; current dispatch is exactly seeds 1–3 followed by the capacity-conditional live history revisit, as ranked on short [rec: floral-grotto-1463] [rec: humble-sky-8445] [rec: first-creek-7901] [rec: easy-beacon-3803] [rec: modest-prairie-3356] [rec: easy-delta-3016]. Preserve history and local artifacts; no archival subsystem or adjacent campaign follows. Empty bookkeeping actor dispatch remains invalid [rec: floral-arrow-7365] [rec: candid-otter-2615] [rec: sleepy-hollow-9498] [rec: northern-comet-5917] [rec: young-timber-2761] [rec: square-light-7067].
