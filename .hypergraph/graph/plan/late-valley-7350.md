...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Cold persistence evidence and the recovery guidance correction are complete. Select only removal of the concrete stale frontier snapshots in agent orientation; ordinary-bundle qualification and a broad documentation audit remain unselected alternatives. Favor narrow subtractive corrections to observed defects; remaining budget does not authorize a new framework or repeated clean walks [rec: fair-cedar-7455] [rec: twilight-key-7506] [rec: careful-sand-9714] [rec: first-wing-3387].
