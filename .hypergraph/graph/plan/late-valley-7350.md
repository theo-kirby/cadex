...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** ADR-245 shipped with 197 CLI tests and no skips, and the durable leg's design turn wrote both domain notes. Catalog placement held on two fresh leg designs; a resumed modification remains unexercised. ADR-246 has fixed the output label with persisted-row/commit regressions and real toy iterate evidence. The durable repair attempt stopped at a usage-credit refusal, leaving only runtime metadata changes and no new review or comparison; the offline diagnosis and ADR-247 correction have now landed, with required restore metadata preserved and redundant unchanged-session writes removed (206 CLI passes, no skips). That finite walk passed and its scratch artifact-tracking rejection was fixed forward. First-visit Git ownership and its exact guidance correction are complete, with 206 CLI passes and no Git implementation change. Output-loss consent and cold recovery are qualified without a defect; the seven-suffix source parity check also found no omission. Neither audit repeats without a new trigger. Linked-part source independence is now qualified without a mismatch (four staged CLI exits, exact-solid cold export, 25 focused passes). Onboarding version guidance is corrected and verified; its conditional repair is exhausted. The suite-count removal passed graph and whitespace verification; its conditional repair is exhausted. Short now contains only evidence-triggered maintenance slots, neither dispatchable without a concrete new failure and a later bet. No actor handoff, adjacent cleanup or repeat baseline is selected; live repair remains parked [rec: curious-badger-6887] [rec: placid-sun-2737] [rec: curious-badger-0797] [rec: weathered-trail-0874] [rec: shy-beacon-2513] [rec: cool-raven-8938] [rec: calm-sky-2656] [rec: lawful-union-8346] [rec: green-shade-8828] [rec: silver-rain-7333] [rec: empty-ledge-4581] [rec: sleepy-meadow-2615] [rec: fresh-flint-1505] [rec: little-fern-0464] [rec: rich-creek-7708] [rec: lucid-snow-0350] [rec: scarlet-journey-0203] [rec: polished-tide-5222]. No further metadata diagnosis is scheduled [rec: vast-ledge-4610] [rec: ready-otter-2700] [rec: cool-garden-5811]. The live repair stays parked [rec: twilight-snow-9071] [rec: sunny-walrus-5847] [rec: gentle-wind-1003]. Dependency discovery, worker qualification and cold-persistence experiments stay completed; no new diagnostic, worker campaign or swept review integration [rec: lucid-pebble-4000] [rec: fond-star-1809] [rec: forest-shade-2752].
