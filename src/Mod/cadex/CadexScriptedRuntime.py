...
def _capability_api_listing() -> dict[str, dict[str, Any]]:
    ...
    listing["assembly"]["notes"] = (
        ...
        "because a joint states position limits and never a speed. A "
        ...
        "the joint keeps every degree it has, so disturbances and gravity "
        "still put it anywhere it really goes. Each "
