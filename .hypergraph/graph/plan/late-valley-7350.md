...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Keep gates green, docs and project records true, and the frontier short. Select one bounded cold-revisit check now that both complete-review rehearsals landed; ordinary-bundle qualification and a documentation consistency audit are unselected alternatives, not additional work queues. Prefer subtractive fixes to observed failures; a clean check does not license a new framework or repeated no-change evidence runs [rec: modest-grotto-1192].
