...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Tally removal, placement guidance and ADR-244 worker repair are qualified. Short now selects the existing bounded dependency discovery experiment and then one eligible two-servo walk; discovery grants no diagnostic implementation authority. Fresh agent compliance is still unmeasured. General worker races and the historical source writer remain unknown, and swept review expansion stays unselected [rec: windy-dune-3488] [rec: misty-tide-6394] [rec: lawful-dune-3795] [rec: snowy-cove-0032] [rec: calm-beacon-7800] [rec: brave-pebble-4147].
