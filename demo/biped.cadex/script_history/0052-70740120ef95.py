...
def build_leg(sgn, tag):
    ...
    gusset = rbox(6.0, 6.0 + T, -MB - LT, 3.0, RH, ZA + 6.0, sgn)
    ankle = part.compound(
        [part.cut(part.fuse([hub_ar, gusset, wl_ap]), tl_ap + th_ar), sv_ap])
...
TZ = ZHR + 20.0
pelvis = part.box(T, 2.0 * HY + 22.0, TZ + 2.0 - (ZHR - 13.0),
                  origin=[6.0, -HY - 11.0, ZHR - 13.0])
