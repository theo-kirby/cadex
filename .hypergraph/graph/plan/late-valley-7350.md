...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Tally removal and placement guidance landed; agent compliance awaits the quota-gated two-servo walk. Scratch diagnosis reproduced stale worker bytes under a content-addressed name and excluded the tested CMake copy/install primitives. This bet selects the bounded creation/reuse repair before the rehearsal; historical cause remains unknown. Dependency-path discovery stays deferred and swept review expansion stays unselected [rec: windy-dune-3488] [rec: misty-tide-6394] [rec: nimble-basin-8423] [rec: snowy-cove-0032] [rec: amber-fjord-1560].
