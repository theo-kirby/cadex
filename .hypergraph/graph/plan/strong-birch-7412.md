...
1. **Worker identity before further lifecycle evidence (missions 1 and 2).** The engine is broken under reproduced in-place source mutation: presence-only reuse accepts wrong bytes under an A-derived name. The supported CMake primitives tested did not cause it. Short selects snapshot isolation and validated reuse, with fresh source/payload gates; this is a repair obligation, not a new cache architecture or a claim that prior successful walks failed [rec: nimble-basin-8423] [rec: amber-fjord-1560].

2. **Preserve completed lifecycle and review criteria (missions 1, 2 and 6).** Four fresh walks and cold persistence remain the successful baseline; the installed bundle carries ADR-241/242 and passed packaged lifecycle 15. The fifth, two-servo attempt stopped at provider quota before authoring and adds no mechanism or review evidence. The unsupported tally is now removed under ADR-243: full engine 2078 passed/52 skipped, CLI 195 passed/no skips, fresh packaged lifecycle/inventory 24 passed. The installed bundle remains stale relative to that correction [rec: windy-dune-3488]. Keep source, fresh payload and ordinary installed bundle evidence distinct [rec: first-branch-9614] [rec: quiet-vine-3426] [rec: morning-summit-7848] [rec: silent-mist-5233] [rec: odd-ridge-9607] [rec: staid-willow-6557].
3. **Catalog-part integrity in review (missions 2 and 6).** The published-output proposal is infeasible on the accepted fused pan-tilt design: fourteen outputs, zero catalog stamps, no separate servo outputs. The call tally removal landed. Placement guidance has landed with CLI 195 passed/no skips; fresh agent compliance is still unmeasured. Short retains one quota-gated walk after the cache repair [rec: misty-tide-6394] [rec: amber-fjord-1560]. Neither call counts nor a zero diagnostic prove physical part completeness. Catalog identity through the part dependency graph remains a separate, unselected direction: snowy-cove-0032 bounds a read-only experiment separating dependency roles and cold-report limits, but it remains deferred behind guidance and the observed cache failure. Neither syntactic reachability nor matching definitions proves surviving material or purchases; no persistent metadata or implementation is selected [rec: snowy-cove-0032] [rec: modest-valley-3313]. No catalog breadth criterion is promoted [rec: odd-ridge-9607] [rec: forest-hollow-9339] [rec: staid-willow-6557].
4. **The clearance direction remains closed (missions 1, 2 and 6).** ADR-241 and ADR-242 have measured initial and swept frame corrections; the installed bundle's catalog assembly passed twenty bound comparisons with a failing negative control. The walk reviews initial pose; swept rollout review integration remains unselected. Existing pan-tilt contacts remain project design findings, not a new product gap or a selected iterate study [rec: southern-otter-5999] [rec: morning-summit-7848] [rec: staid-willow-6557].

No new charter gap or Later promotion. Tally removal and placement guidance are complete. Scratch diagnosis is complete; the selected repair is bounded by the reproduced failure, while the historical cause stays unknown [rec: windy-dune-3488] [rec: misty-tide-6394] [rec: nimble-basin-8423] [rec: amber-fjord-1560]. GUI-attached lifecycle remains documented-only, remote remains scripted-only, and toy policy witness success does not establish gait performance. After the bounded units, re-plan from their evidence; do not turn an unavailable provider into repeated empty rehearsals or unrelated inherited-tree work [rec: modest-summit-8554] [rec: silent-mist-5233] [rec: staid-willow-6557].
