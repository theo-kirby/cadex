...
def build_leg(sgn, tag):
    ...
    tg_in = rbox(-13.0, 13.0, -9.0, -9.0 + LT, ZK - 11.0, ZHP + 11.0, sgn)
    tg_out = rbox(-13.0, 13.0, LW - LT, LW, ZK + 20.0, ZHP + 11.0, sgn)
    tg_parts = [hub_kn, tg_in, tg_out, wl_hp]
    if ZHP - 14.0 > ZK + 25.0:
        tg_parts.append(rbox(-13.0, -13.0 + LT, -9.0, LW,
    ...
    hip_plate = rbox(-13.0, 13.0, 6.0, 6.0 + T, ZHP - 11.0, ZHR + 10.0, sgn)
    hip = part.compound(
