...
1. **Qualify one shafted 28xx winding in BLDC set A (mission 4; rising-banner-4325, brave-stone-9609).** One bounded source audit using a manufacturer dynamometer report and matching mounting drawing. Select one named winding; the existing Skywalker may be qualified if new evidence supports it, otherwise audit one alternative. Retain kV, voltage, current definition, speed, duration/duty, cooling, temperature and rating/drawing revision linkage; distinguish missing fields from assumptions and never infer usable torque from kV. Set A is already defined: do not repeat its definition or the RI50 fixture/page searches. Record inspected sources and exact blockers in current docs and a work node; no geometry or public API in this unit. If this alternative audit fails, stop the motor-search sequence and replan toward medium's bounded residual GUI work. No candidate is prequalified. [rec: slender-harbor-9625] [rec: shy-hill-8139] [rec: vast-oak-7458]
2. **Prove that qualified shafted winding's interfaces, only after item 1 succeeds (mission 4; rising-banner-4325, brave-stone-9609).** One standalone actual-worker experiment independently measuring sourced shaft/collar and mounting interfaces, canonical/placed material and void boundaries, with numerical evidence and explicit approximations. For an already delivered winding, reuse valid prior geometry evidence and test only newly changed or unproved interfaces; do not repeat a completed proof. Keep thermal qualification separate from installed fit, physical inertia and powered assembly behavior. A source gap blocks dispatch; a failed proof records the boundary and triggers replanning. No public recipe yet; run the touched zone's gates and at most one full build. RI50 remains parked. [rec: windy-lily-2895] [rec: steady-rain-3009] [rec: shy-hill-8139] [rec: vast-oak-7458]
3. **Deliver or qualify that one proven catalog winding, only after source and geometry evidence are recorded (mission 4; rising-banner-4325, brave-stone-9609).** One catalog/library unit through existing lib.bldc: carry qualified manufacturer ratings and provenance, independent canonical/placed interface tests and packaged publication coverage; update ADR and ROADMAP facts. Reuse an existing value/recipe where the sourced contract fits, without duplicating a SKU or inventing dimensions. Run the full engine suite, at most one required full build, complete install/staging before actual-worker and packaged lifecycle/library checks, and report skips and relocation limits. No actuator dynamics. This advances only set A's shafted row; 50/80 frameless qualification, full L3 and solenoids remain open. [rec: slender-harbor-9625] [rec: open-pine-9349] [rec: vast-oak-7458]
