...
def _capability_api_listing() -> dict[str, dict[str, Any]]:
    ...
    listing["assembly"]["notes"] = (
        ...
        "height_mm=[low, high], angular_velocity_dps=[low, high]) starts "
        ...
        "that does not, with the millimetres in the message. A disturbance's "
        "force acts at the component's centre of mass in the world frame. "
