...
2. **Standing lifecycle maintenance (missions 1/2/6).** CPU setup, shared regressions, recovery and offline remote preflight are delivered. The bounding-box motion screen was retired after measurement; rollout travel reporting and comparison replaced it and have landed. Current dispatch is retention repair followed by comparison identity and a conditional history revisit, as ranked on short. Preserve history and local artifacts; no archival subsystem or adjacent campaign follows. Empty bookkeeping actor dispatch remains invalid [rec: floral-arrow-7365] [rec: candid-otter-2615] [rec: sleepy-hollow-9498] [rec: northern-comet-5917] [rec: young-timber-2761] [rec: square-light-7067].
