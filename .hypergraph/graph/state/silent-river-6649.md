...
**Wren's second lifecycle includes revised-foot retraining and a four-policy comparison on seeds 0–4, eight seconds at 50 Hz, but its product-agent revision remains unproven.** Original/revised checkpoint20 policies both survive 5/5 episodes, with mean X displacement +43.078/+41.782 mm. Original final has two falls, mean survival 4.98 s (minimum 0.44 s) and mean displacement -10.357 mm; revised final survives 5/5 for eight seconds with +52.647 mm mean displacement. Twenty rollouts verify retained identities and seed-zero trace reproduction. One training seed per design establishes neither repeatable walking nor an isolated causal geometry effect. The 85→105 mm revision was a public CLI parameter edit, not product-agent authorship, and the retraining must not receive retrospective authorship credit [rec: frosty-birch-2464].

Every comparison-informed product-agent revision attempt on Wren since then has exited 1 at the provider session limit before authoring: Fable and Sonnet turns after the retraining [rec: smooth-pine-9795], a retry on the 110 mm copy [rec: dawn-bell-5364], and a further bounded prompt on `ot5-wren-copy54` with the retained comparison, agent-chosen geometry change, policy disabled first and training forbidden — stored `claude-sonnet-5` returned exit 1 with no outputs or accepted revision [rec: calm-grove-2647]. No caller edit or training was substituted for any of these; each iteration's fallback unit (review defect fixes ADR-306/307) is not counted as lifecycle progress. Judgement: retain `working` for Reed's demonstrated lifecycle while Wren's product-agent revision gap stays open; a future attempt needs fresh evidence of actual provider capacity, not an elapsed reset time [rec: dawn-bell-5364] [rec: calm-grove-2647].
