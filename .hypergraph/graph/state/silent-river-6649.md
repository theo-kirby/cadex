...
Keep `open`: whole-goal completion is not claimed. Both designs have playable videos and common-seed measurements, but the lifecycle report linking D1–D8 evidence is still missing, and the shin55 training-time view was frozen before ADR-302 so it shows five of eight parts and says so [rec: fair-crow-5108].
