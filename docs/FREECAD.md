...
Material GUI scripts still survive in the payload. MeshPart/InitGui.py
installation is disabled with stale-copy cleanup; its source remains for a
separately verified deletion (ADR-224, PHASE8-AUDIT.md);
