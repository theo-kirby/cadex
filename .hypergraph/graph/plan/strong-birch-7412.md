...
1. **Residual Phase 8 GUI-source obligations (mission 3; round-glacier-2865; directory evidence civic-sand-2641).** Directory deletion, residual audit, Measure and MeshPart disable/delete landed; Material's exact three-entry audit and verified install disable now landed too. The Main audit has also landed and the separate maintainer reconciled the ordering handoff. Short now explicitly resumes Material source deletion, then deletes only the already-disabled Main GUI resource template. Do not repeat the completed audit or dispatch handoff. [rec: southern-isle-5110] [rec: falling-orchard-6118] [rec: amber-tower-7307] Broader no-GUI-source wording remains unproved; mixed helpers/resources remain separate obligations. Preserve Measure App identity, required Assembly proxies, Material App/tests/resources including TestMaterialDocument and retained Qt. The four inactive arms in the shared Main launcher remain deferred pending a Windows validation path and later explicit bet; preserve their active command-line alternatives and shared helpers. Template deletion does not satisfy that behavior gate; no publisher replacement is authorized. [rec: southern-isle-5110] [rec: amber-tower-7307] [rec: humble-shore-1680] [rec: small-tide-8341] [rec: light-peak-0510] [rec: light-arbor-2584] [rec: odd-bramble-2068] [rec: placid-chart-1292]
2. **Remaining L3 motors and mechanisms (mission 4; rising-banner-4325, brave-stone-9609).** Qualification is deferred after the failed AT2814 alternative audit; short now completes the verified Material removal sequence and the audited template-only Main deletion. [rec: amber-tower-7307] No motor search, proof or delivery until new qualifying evidence and an explicit replan. Set A is defined: shafted 28xx, hollow frameless 50 and 80, each with a qualified winding, independent worker proof and packaged publication. Existing Skywalker torque qualification is absent; RI50 is parked after the fixture follow-up left thermal/revision gaps; the 80-class row is unqualified. Retain these obligations without repeating searches or treating envelopes as plural coverage. AT2814 remains blocked on current definition, thermal conditions and rating/drawing linkage; full L3 stays open. Solenoids remain deferred pending new revision-matched mounting/travel evidence, a qualified alternative or a separately justified narrower contract. Deliveries require provenance, full engine and real-worker tests, required build and completed staging before packaged gates. N20 verification landed; L12 and GE 6 C geometry proves neither installed fit nor physical inertia nor automatic dynamics, and L12 is not a conservative collision envelope. Compound gearing stays long. [rec: slender-harbor-9625] [rec: shy-hill-8139] [rec: vast-oak-7458] [rec: mild-harvest-8460] [rec: sharp-oak-9030] [rec: windy-lily-2895] [rec: open-pine-9349] [rec: morning-field-8202]
3. **Retain honest fork delta and further bounded reductions (mission 3; green-sea-3991, round-glacier-2865).** Help/Start's two whole-tree criterion is now working in the reconciled state: the final manifest check and separate GSL cleanup passed. Do not redispatch either or invent a Test-removal contingency. Recorded FreeCAD M files/inserted/deleted are 56/1637/1819 after Material disable [rec: odd-bramble-2068] versus nt2 start 7dd3d045 at 47/1804/1907; the prior inherited-remaining measurement was 3440 versus 7277, excluding added files; MeshPart subsequently deleted one unmodified inherited file (73 lines), so refresh that count at the next measurement rather than presenting the old figure as current. [rec: light-peak-0510] [rec: shady-ivy-2659] Blender remains 44/1046/129 and 19052 inherited files; GSL changed neither surviving-file modification set. Both M line totals fell while M file count rose, so the broad criterion remains open with reproducible measurements. Whole-file deletion credit belongs to inherited remaining; surviving edits can independently change M. Subsequent reductions need their own bounded audit, separate disable/delete, notices and gates. [rec: rustic-spire-7084] [rec: late-pond-3758] [rec: frosty-dawn-2061]
4. **The hide_render shell defect (mission 1 maintenance; wild-comet-8096).** Follow the current ladder after reductions and remaining L3 unless evidence makes it an active lifecycle regression. Pin old behaviour with a failing test, fix the owned shell surface and run pixi run gate headlessly; keep inherited changes within the manifest contract. [rec: empty-wolf-3962] [rec: lone-wood-3732] [rec: silver-sage-7486]
