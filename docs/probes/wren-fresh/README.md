...
Current run: **`wren71-final`**, the completed 240-update repeat of the product
agent's 90 mm design for [restart during real training](RESTART-TRAINING.md),
with verified checkpoint/final videos and the persistent service still running. The previous
**`wren66-final`** remains the seed 0–4 comparison
([REVISION66.md](REVISION66.md), ADR-308).
