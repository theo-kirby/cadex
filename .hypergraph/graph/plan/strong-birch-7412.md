...
1. **Measured surviving fork differences and further bounded reductions (mission 3; green-sea-3991, round-glacier-2865).** The finite surviving-diff audit/Preferences reduction and the independent Test Tk disable/delete pair are complete. The updater audit/disposition now qualifies exactly one additional boundary, the deleted GUI writer; preserve MainCmd/TestSources, the 37 other Test files and required GUI-lineage consumers. New reductions require independent dependency evidence and a later bounded bet, with separate disable/delete commits and manifest/notice checks. Current FreeCAD M files/inserted/deleted are 56/1634/1820 and inherited remaining 3433, versus nt2 start 7dd3d045 at 47/1804/1907 and 7277. Blender remains 44/1046/129 and 19052 inherited files. Report both declining line totals and increased M file count, separately from whole-file savings. Help/Start, GSL, Measure, MeshPart, Material, Main template, Preferences and Tk are completed subsets, not repeat dispatches or broad closure. [rec: proud-branch-1079] [rec: proud-moon-9023] [rec: simple-oak-4775] [rec: silver-lodge-1952] [rec: narrow-pebble-8020] ADR-232 audit and disposition are complete; short now dispatches only the writer disable and conditional helper/import deletion, in separate gated commits. No saving is claimed until measured implementation evidence. [rec: eager-garden-8009] [rec: cold-clover-8123] [rec: damp-sand-1115] [rec: noble-clover-4083] [rec: hollow-reef-8734]
