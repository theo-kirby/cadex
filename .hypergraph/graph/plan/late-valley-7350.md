...
2. **Standing lifecycle maintenance (missions 1/2/6).** History/context fixes, the live history iterate, uninterrupted resumed walk, section ranking and standalone derived sections have landed. Model persistence and missed moving-object reporting have also landed. Current short leads with a capacity-conditional fresh mixed-joint run, then the existing detach direction bounded to a pending receipt after completion or refusal [rec: restless-wave-7376] [rec: idle-pond-4961] [rec: clear-shade-1084]. These are existing units; no new direction or removal campaign is selected. Preserve project history and local evidence [rec: humble-star-3313] [rec: sage-glacier-2165] [rec: rising-rain-0117] [rec: neat-grotto-9232] [rec: silent-anchor-7513].

3. **This machine's evidence.** The swing-arm prompt walk exited 0 in 17:43; the prismatic carriage prompt walk in 359.8 s. The model-free carriage width change 70→80 mm completed in 20.89 s at peak RSS 1,760,116 KiB, preserved 21 baseline files and automatically recorded reward 3.296298→2.760187 over equal 200-step rollouts. Four eyes were inspected: named renders, XZ section, two-component inventory and 0.5 mm clearance with zero intersection. This is toy pipeline and initial-pose evidence, not motion safety, printable fit, general design ranking or learned gait. The former fixed-plane misses are historical: section derivation and coverage ranking have shipped, and standalone derivation now measures 6/10 objects cut on ot4-swing2; the later report join now names missed moving objects, without adding another cut or swept coverage [rec: idle-pond-4961] [rec: wandering-jasper-6102] [rec: rare-cliff-9595] [rec: mellow-quartz-8093] [rec: rising-rain-0117] [rec: neat-grotto-9232].
4. **Runtime reporting is delivered.** ADR-251 reports match/different/unavailable before the first leg, in JSON and stderr. The iterate measured 56 matching top-level Python files; neither matching bytes nor successful review establishes binary or loaded-module provenance. No rebuild, refusal or engine-resolution redesign follows. Latest recorded CLI gate: 285 passed, no skips [rec: idle-pond-4961] [rec: solar-snow-8543] [rec: modest-prairie-3356] [rec: narrow-wing-0418] [rec: mellow-quartz-8093] [rec: northern-quartz-8401].
...
6. **Reduction and wider ambitions.** nt2's inherited-tree reduction stays standing-only: take a cheap necessary removal during authorized work under its protocol, never a fresh campaign. Catalog, manufacturer STEP, compound mechanisms, outside-source work, studies, reports and mg-legs remain parked. Keep gates green, docs and manifest honest and the frontier short without inventing a bookkeeping actor iteration [rec: autumn-arrow-3125] [rec: modest-summit-8554] [rec: frosty-wolf-4770].
7. **The kernel swept check over the dynamics rollout, as a direction (missions 2/6).** The engine already measures a swept clearance, but only inside `assembly.simulation`'s kinematic trace, declared pair by pair and refusing on breach (ADR-130, ADR-242); the walk's motion is `assembly.rollout`, which has no such surface. Bringing a kernel-accurate check to the rollout is engine-zone work in `CadexDynamics.py` with the packaged gate behind it, and it would have to answer the refusal question this run settled in favour of reporting. The CLI-side bounding-box screen was measured and retired; kernel rollout checking remains unselected, and its promotion requires a separate justified bet [rec: sleepy-hollow-9498] [rec: square-light-7067] [rec: strong-falcon-1463] [rec: morning-summit-7848].
