...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Cold persistence, recovery, orientation, VISION and engine-selection guidance corrections are complete; ordinary bundled-engine qualification and refresh landed. The standing rule for an empty short rung is the charter ladder's: run the documented walk end to end and record the leg that needs a person or a guess. This pass selects that run on an unwalked two-servo topology and nothing else. No framework, dependency, wider audit or parked criterion follows [rec: fair-cedar-7455] [rec: polished-moss-9358] [rec: neat-summit-3586] [rec: strong-raven-3067] [rec: keen-pebble-3574] [rec: salty-nest-8235].
