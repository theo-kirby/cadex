...
1. **The hide_render shell defect (mission 1 maintenance; wild-comet-8096).** Promoted to short after both prior units landed: first qualify actual headless rendering and marker-owned visibility transitions, then fix only the reproduced boundary with an old-behavior-failing regression and full pixi run gate. No GUI launch or inherited Blender edits. This remains an open criterion until actor evidence supports closure; rendering a fixture alone does not deliver the general headless review tools. [rec: empty-wolf-3962] [rec: proud-moon-9023] [rec: tidy-sea-8308]
2. **Measured surviving fork differences and further bounded reductions (mission 3; green-sea-3991, round-glacier-2865).** The finite audit and its sole qualified Preferences guard reduction are complete; no further candidate is qualified by that audit. Preserve this open obligation and resume only with new evidence and an explicit bounded bet. FreeCAD surviving M files/inserted/deleted are 56/1634/1819 and inherited remaining 3434, versus nt2 start 7dd3d045 at 47/1804/1907 and 7277. Blender remains 44/1046/129 and 19052 inherited files. Both M line totals fell while M file count rose; report both measures and do not infer broad closure. Help/Start, GSL, Measure, MeshPart, Material, Main template and Preferences are completed subsets, not repeat dispatches. Functional removals retain separate disable/delete commits; no resurrection or formatter-policy workaround. [rec: proud-branch-1079] [rec: proud-moon-9023] [rec: tidy-sea-8308]
