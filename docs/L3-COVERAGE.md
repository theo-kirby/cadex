...
| rack and pinion (ADR-234) | Pre-build: 2061 passed, 52 skipped (the cadexd publication test failed against the stale installed engine and passed after the build) | 119 passed, no skips, 80.77 s |
