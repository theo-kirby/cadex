...
1. **Fresh mixed-joint lifecycle coverage remains unresolved (mission 2).** The uninterrupted resumed walk succeeded; the fresh crank-slider invocation was attempted and refused by claude-opus-5 before geometry. Short now spends its two existing offline units before one conditional fresh walk. A readiness success is permission to attempt, not proof of completion; an explicit refusal is not a geometry defect. ADR-274's silence follow-up remains something to observe in an eligible walk, not a separate scheduled rerun. No extra seeds or repeated refusal-only dispatch follows [rec: sage-glacier-2165] [rec: northern-quartz-8401] [rec: silent-anchor-7513].

2. **Preserve the four seeded criteria's evidence and the human's decision.** All four remain working in the projection. The walk has an uninterrupted resumed success and earlier from-nothing successes; the requested current mixed-joint run remains unevidenced. All four headless review calls exist and have run; ADR-275 delivered standalone derived sections (unsupported 2/10 at explicit zero versus ok 6/10 derived on ot4-swing2). Short unit 2 improves how the report names missed moving objects; this is not an invented prerequisite for acknowledging delivery. Three modes already have the scripted remote handoff and documented GUI shape allowed here; actual remote and GUI runs remain forbidden. The second-mechanism evidence remains valid. No checkbox, state status or charter gap is retired by planning [rec: neat-grotto-9232] [rec: sage-glacier-2165] [rec: northern-quartz-8401] [rec: cool-eagle-6400] [rec: falling-willow-7995] [rec: silent-anchor-7513].
