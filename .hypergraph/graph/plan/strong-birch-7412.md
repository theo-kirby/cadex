...
1. **Preserve completed lifecycle and review criteria (missions 1, 2 and 6).** Four fresh walks and cold persistence remain the successful baseline; the installed bundle carries ADR-241/242 and passed packaged lifecycle 15. The fifth, two-servo attempt stopped at provider quota before authoring and adds no mechanism or review evidence. Current source additionally contains the unverified tally accidentally committed in 997293b8; short repairs that discrepancy before claiming current-source qualification. Keep source, fresh payload and ordinary installed bundle evidence distinct [rec: first-branch-9614] [rec: quiet-vine-3426] [rec: morning-summit-7848] [rec: silent-mist-5233] [rec: odd-ridge-9607] [rec: staid-willow-6557].
2. **Catalog-part integrity in review (missions 2 and 6).** The published-output proposal is infeasible on the accepted fused pan-tilt design: fourteen outputs, zero catalog stamps, no separate servo outputs. Short therefore removes the unsupported call tally and promotes the previously planned placement convention, followed by one quota-gated walk. Neither call counts nor a zero diagnostic prove physical part completeness. Catalog identity through the part dependency graph remains a separate, unselected direction: a later bet must first distinguish retained geometry, cuts, discarded values and repeated component placement, and justify its cost against the already-working review criterion. No catalog breadth criterion is promoted [rec: odd-ridge-9607] [rec: forest-hollow-9339] [rec: staid-willow-6557].
...
No new charter gap or Later promotion. The current maintenance bet selects corrective simplification over dependency discovery or swept review expansion. GUI-attached lifecycle remains documented-only, remote remains scripted-only, and toy policy witness success does not establish gait performance. After the bounded units, re-plan from their evidence; do not turn an unavailable provider into repeated empty rehearsals or unrelated inherited-tree work [rec: modest-summit-8554] [rec: silent-mist-5233] [rec: staid-willow-6557].

## Negative knowledge

- [scope: fused catalog diagnostic and provider availability | confidence: high | evidence: odd-ridge-9607] The accepted pan-tilt design has fourteen outputs and no catalog stamps; scanning published outputs cannot recover either fused servo. The generator tally captured in 997293b8 was not verified by either subsequent experiment and lacks its referenced ADR. Calls cannot establish purchased quantities. The two-servo attempt was refused before design; quota percentages do not establish availability [rec: odd-ridge-9607] [rec: silent-mist-5233].
