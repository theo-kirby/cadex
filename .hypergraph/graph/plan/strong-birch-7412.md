...
1. **Measured surviving fork differences and further bounded reductions (mission 3; green-sea-3991, round-glacier-2865).** Short promotes a finite audit and one conditional reduction after both previous units landed. Help/Start, GSL, Measure, MeshPart, Material and the Main template are completed subsets, not dispatches to repeat. FreeCAD surviving M files/inserted/deleted are 56/1637/1819 and inherited files remaining 3434, versus nt2 start 7dd3d045 at 47/1804/1907 and 7277. Blender remains 44/1046/129 and 19052 inherited files. Material removed three files (1093 lines); Main removed one template (47 lines); these whole-file deletions leave surviving M totals unchanged. Both M line totals fell while M file count rose: preserve the broad criterion as open and report both measures. [rec: icy-tree-0009] [rec: chilly-summit-3112] [rec: easy-sea-7738] Subsequent functional removals retain the separate disable/delete protocol; no replacements or resurrection of retired behavior. A negative audit triggers replanning to existing work rather than repeated searches. [rec: easy-sea-7738] [rec: late-pond-3758]
2. **Residual Phase 8 GUI-source obligations (mission 3; round-glacier-2865; directory evidence civic-sand-2641).** Material script deletion and Main template deletion now join the landed directory, Measure and MeshPart subsets. Broader no-GUI-source wording remains unproved; preserve required Assembly proxies, Measure App identity, Material App/tests/resources including TestMaterialDocument and retained Qt. The four inactive shared Main launcher arms remain deferred pending a Windows behavior-validation path and later explicit bet; static resource checks do not satisfy it. No mixed publisher replacement is authorized. [rec: icy-tree-0009] [rec: chilly-summit-3112] [rec: southern-isle-5110] [rec: humble-shore-1680] [rec: easy-sea-7738]
3. **Remaining L3 motors and mechanisms (mission 4; rising-banner-4325, brave-stone-9609).** Qualification remains deferred after the failed AT2814 alternative audit; both GUI subsets landed and short now tests whether one surviving fork difference is redundant. [rec: easy-sea-7738] No motor search, proof or delivery until new qualifying evidence and an explicit replan. Set A is defined: shafted 28xx, hollow frameless 50 and 80, each with a qualified winding, independent worker proof and packaged publication. Existing Skywalker torque qualification is absent; RI50 is parked after the fixture follow-up left thermal/revision gaps; the 80-class row is unqualified. Retain these obligations without repeating searches or treating envelopes as plural coverage. AT2814 remains blocked on current definition, thermal conditions and rating/drawing linkage; full L3 stays open. Solenoids remain deferred pending new revision-matched mounting/travel evidence, a qualified alternative or a separately justified narrower contract. Deliveries require provenance, full engine and real-worker tests, required build and completed staging before packaged gates. N20 verification landed; L12 and GE 6 C geometry proves neither installed fit nor physical inertia nor automatic dynamics, and L12 is not a conservative collision envelope. Compound gearing stays long. [rec: slender-harbor-9625] [rec: shy-hill-8139] [rec: vast-oak-7458] [rec: mild-harvest-8460] [rec: sharp-oak-9030] [rec: windy-lily-2895] [rec: open-pine-9349] [rec: morning-field-8202]
4. **The hide_render shell defect (mission 1 maintenance; wild-comet-8096).** Retain as the next existing alternative if the bounded reduction audit yields no locally verifiable candidate; do not let indefinitely deferred Windows or motor qualifications prevent its promotion in the next bet. Pin old behavior with a failing test, fix the owned shell surface and run pixi run gate headlessly. No GUI launch; keep inherited changes within the manifest contract. [rec: empty-wolf-3962] [rec: lone-wood-3732] [rec: easy-sea-7738]
