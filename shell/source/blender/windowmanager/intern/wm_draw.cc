...
#define SPACE_NAME(space) \
  ...
  switch (eSpace_Type(area->spacetype)) {
    ...
    SPACE_NAME(SPACE_CADEX_CHAT);
    SPACE_NAME(SPACE_CADEX_PARAMS);
    SPACE_NAME(SPACE_CADEX_ENV);
    SPACE_NAME(SPACE_CADEX_POLICY);
    SPACE_NAME(SPACE_CADEX_TRAINING);
    SPACE_NAME(SPACE_CADEX_LIVE);
    SPACE_NAME(SPACE_CADEX_BLUEPRINT);
