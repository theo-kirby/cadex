...
def _capability_api_listing() -> dict[str, dict[str, Any]]:
    ...
    listing["assembly"]["notes"] = (
        ...
        "about +X -- omitted is the whole circle, and it is refused on a "
        "vertical push, whose draw is a sign rather than an angle. Aim the "
        "arc where the mechanism has actuators: drawing over the whole circle "
        "on a machine with no ankle roll spends most of a batch on a question "
        "it cannot answer. "
