...
**example project card** when a demo ships ("EXAMPLE PROJECT" over its
`card.png` render — click it and a fresh copy lands under
`~/Documents/Cadex Demo/` and opens; hidden since ADR-171, which removed
the drone demo) and three actions: **New File**
