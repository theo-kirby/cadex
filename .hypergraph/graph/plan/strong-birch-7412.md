...
1. **L3 motors and mechanisms (mission 4; rising-banner-4325).** N20 and the bounded HOBBYWING BLDC envelope have source, real-kernel and packaged evidence. L12 remains the active short work: its source audit chose datasheet nominal mounting centres but shipped no family; prove that geometry and then deliver the catalog variant. Solenoid and joints stay here until existing short work lands or is evidenced blocked; further BLDC sizes require a concrete family need. Each delivery requires provenance, real-kernel tests and packaged verification. Preserve BLDC's unsupported torque/coupling-fit limits; do not call a source audit an implementation or close L3 from one family. Compound gearing stays long. Continue this existing family order before reductions. [rec: idle-dawn-5426] [rec: floral-stone-2866] [rec: southern-moss-9142] [rec: western-water-1442]
