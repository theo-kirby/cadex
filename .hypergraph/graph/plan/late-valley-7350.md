...
2. **Standing lifecycle maintenance (missions 1/2/6).** Keep the walk working and its docs true; use concrete run failures or contradictions to name bounded corrections. Both guide corrections landed with 223 CLI passes each; no concrete repair remains selected [rec: still-harvest-7242] [rec: floral-canyon-9424]. Standing maintenance now requires new failure evidence before actor dispatch [rec: sharp-garden-2483]. The latest full iterate satisfies the empty-rung rehearsal before these units; it is not authority for repeated green walks after documentation-only edits [rec: mellow-quartz-8093] [rec: frosty-wolf-4770].
