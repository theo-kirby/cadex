...
1. **Selected finite direction: self-contained historical inventory review (missions 1/2/6).** Saved reviews retain counts and a link to a mutable latest inventory document; source inspection shows named rows and revision are discarded despite being available. Project Git still retains history. Short first measures and explains this boundary, then preserves those existing fields with a regression. This maintains the headless review criterion; it is not catalog breadth or a new reporting platform [rec: scarlet-ocean-2920].
2. **CPU and recovery directions are delivered.** Explicit CPU rehearsal: 14.6 s, 1.54 GB, verified policy and all reviews. Shared requested fixture: 223 passed, no skips, no outer CPU override; fake GPU/refusal cases remain green. Remove both spent CPU dispatches; no CUDA diagnosis, repeated recovery or backend matrix follows [rec: floral-arrow-7365] [rec: keen-field-4379] [rec: placid-ember-6741].
3. **Three candidates and budget.** Select historical inventory fidelity from the observed lossy projection; reject another CPU/recovery matrix and reject parked catalog/fleet expansion. Signals: 15 iterations, 4.8h elapsed, 43.2h left, nine iterations without frontier movement, Claude five_hour 100%, Codex seven_day 74%. Two finite model-free units fit; spare budget is no mandate for further work. No clock gating or bookkeeping-only actor fallback [rec: careful-union-7585] [rec: scarlet-ocean-2920].
4. **Evidence and scope limits.** All seeded criteria already have working evidence; no charter checkbox or gap is retired here. GUI remains documented/unexercised, remote parity a local stand-in, runtime comparison Python bytes only. Toy pipeline success does not prove policy improvement or swept-motion safety. Reduction remains standing-only and all Later criteria stay parked [rec: mellow-quartz-8093] [rec: early-quill-3654] [rec: narrow-wing-0418] [rec: keen-field-4379] [rec: scarlet-ocean-2920].
