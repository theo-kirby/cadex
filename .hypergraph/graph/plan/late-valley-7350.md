...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Cold persistence, recovery guidance and orientation corrections are complete. Carry only the verified VISION principle 5 correction distinguishing offboard training from GPU scale requirements. Ordinary-bundle qualification and a broader documentation audit remain unselected alternatives. Favor narrow subtractive corrections to observed defects; remaining budget authorizes neither a framework nor repeated clean walks [rec: fair-cedar-7455] [rec: twilight-key-7506] [rec: lean-union-6426] [rec: lucky-canyon-6724] [rec: civic-snow-4700].
