...
2. **Standing lifecycle maintenance (missions 1, 2 and 6).** Cold persistence, recovery guidance, orientation and both VISION training-boundary corrections are complete. Select only ordinary bundled-engine qualification and evidence-gated packaging refresh. Broader documentation audits and another persistence probe remain unselected. Use existing public commands to resolve the recorded stale-bundle limitation; add no framework or dependency. Clean qualification ends the direction, and no ordinary-bundle success is claimed before it runs [rec: fair-cedar-7455] [rec: twilight-key-7506] [rec: lean-union-6426] [rec: polished-moss-9358] [rec: neat-summit-3586] [rec: zesty-aspen-6846] [rec: empty-rain-5162].
3. **Measured review baseline and its limits.** Fresh arm/carriage external whole commands took 16.61/16.39 s; sampled peak process-tree RSS was 1,059,241,984/987,168,768 bytes. Each full built-engine CLI gate passed 195 with zero skips. These walks overlapped gates, so samples are observations, not benchmarks. Four named views and interior sections were inspected; arm contact and carriage separation remain explicit. Policy witnesses pass, but carriage falls under gravity, and differing force/torque effort units prevent ranking these rewards as control improvements. No swept-safety, analytic-section or ordinary-bundle claim follows [rec: first-branch-9614] [rec: quiet-vine-3426].
