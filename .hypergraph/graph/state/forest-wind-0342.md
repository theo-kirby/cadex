...
- The engine suite is **1,869 passed / 33 skipped**, measured 2026-08-19, headless and needing no build (`pixi run test-engine`); the skips are MJX-gated by design [rec: forest-wind-3489] [rec: even-cliff-3863] [rec: sage-wood-0687] [rec: windy-wolf-5012]. The packaged lifecycle gate passes against the staged payload with `put_blueprint` served from it (ADR-023's rule, exercised on this feature too) [rec: windy-wolf-5012].
