...
1. **Retry the two-servo leg once eligible (missions 2 and 6, the ladder rule).** Use the same documented walk and exact mechanism prompt from silent-mist-5233 in a fresh project outside the checkout. Dispatch only after the reported 2026-09-08 08:30 Europe/Madrid reset (06:30 UTC), or affirmative availability evidence; eligibility allows one attempt and does not guarantee quota. Use the corrected CLI and lawful-dune-3795's qualified payload at build/engine/cadex-engine-0.0.0-macos-arm64, whose CadexScriptedRuntime.py SHA256 is 602164e85c399ad203517eb269ec81bca549dc07b72d303659c1cffffe1dc6df. Identify the actual engine used; the installed application remains stale. Use the training venv, JAX_PLATFORMS=cpu, --iterations 1 --envs 4 --seed 0 --timeout 600, and the existing 2.9 GiB/850 s process-tree guard. Report each leg as clean, needing a guess/person, or not reached, with exact errors and comparable PROGRESS numbers. Inspect four views and section, manually compare script catalog usage with placed inventory, and use the bound-agreement checker where catalog rows exist. A missing tally or zero catalog rows proves no absence of fused hardware. No source correction in the rehearsal; a failure names the next unit. Record crisp-reef-5607 and swift-dusk-2951 evidence, and damp-moon-9297 only for observed review findings [rec: silent-mist-5233] [rec: morning-summit-7848] [rec: lawful-dune-3795] [rec: calm-beacon-7800] [rec: brave-pebble-4147] [rec: early-gate-3510] [rec: clear-crest-9910].

**Dispatch preflight (supersedes the actor clock-check prohibition).** The controller should schedule this rehearsal at or after 2026-09-08 06:30 UTC. If invoked without established eligibility, the actor may read local UTC once as a prerequisite of this same unit. At or after the boundary, execute the single bounded attempt in that turn; affirmative provider availability evidence also remains sufficient. Before the boundary, return the observed timestamp and not-before boundary to the controller, with no wait, polling, provider probe or repeated unchanged-blocker record. Future invocations may evaluate this condition once again; a clock observation is not its own work unit. No new provider attempt is authorized before eligibility, and eligibility does not guarantee quota. Controller enforcement and the critic's required rehearsal evidence remain unproved [rec: happy-tide-1066] [rec: lively-grove-1806].

Signals: 98 iterations, 8.6h elapsed, 6.4h left; API-equivalent cost $69.43; Claude five_hour 75%, seven_day 47%, Codex seven_day 18%; 29 iterations without change. These size the one bounded rehearsal and establish no present eligibility. Select zero new directions and no medium promotion. Stuck reports 93–97 motivate permitting local preflight instead of preserving a prohibition that prevents an invoked actor from evaluating the condition [rec: happy-tide-1066] [rec: strong-falcon-9003].

Discovery completed and stopped at cold identity and occurrence ambiguity. Do not repeat it or implement a diagnostic. Worker repair and required qualification are complete; do not repeat them. No repeated provider probes, paid fallback, provider switch, GUI launch, remote execution or Later promotion. After the one eligible rehearsal, replan on its evidence; if quota still refuses, record that actual attempt once and return scheduling to the controller. Keep this horizon below its usual two or three units because no second independent unit is justified; do not fill the interval with unrelated work [rec: early-gate-3510] [rec: lawful-dune-3795] [rec: calm-beacon-7800] [rec: clear-crest-9910].

## Negative knowledge

- [scope: eligibility scheduling | confidence: high | evidence: happy-tide-1066] Earlier prohibitions on actor clock checks are superseded by the single preflight above. The 04:51:14 UTC observation is historical, not evidence of present ineligibility. Twenty-nine unchanged iterations add no rehearsal or quota evidence. A local preflight can resolve the condition for an invoked actor; it does not fix controller scheduling or guarantee quota [rec: lively-grove-1806] [rec: happy-tide-1066].
