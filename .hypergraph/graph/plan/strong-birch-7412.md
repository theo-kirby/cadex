...
1. **Two engine-side Phase 13b removals and honest fork delta (mission 3; windy-pebble-4630, green-sea-3991, round-glacier-2865).** Short now qualifies Help and conditionally disables it. Only a passing disable commit can promote its separate delete unit. A second whole-tree candidate still needs a dependency audit: Start builds App and TestSources is a MainCmd dependency, so payload exclusion proves neither removable. Do not count Measure's two commits as two removals. After the bounded short pair, re-rank deletion/second-candidate work against residual cleanup and L3; do not promise exhaustive removal before catalog work. FreeCAD manifest-scoped totals are 56 files / 1633 inserted / 1796 deleted versus nt2 start 7dd3d045 at 47 / 1804 / 1907; Blender stays 44 / 1046 / 129. Directory deletion volume and the later Measure shim's one file / 1477 bytes are separate metrics. Broad delta remains open; preserve manifest/notices and unscheduled replacements. [rec: wise-isle-1725] [rec: humble-shore-1680] [rec: small-tide-8341] [rec: quiet-canyon-3950]
2. **Residual Phase 8 GUI-source obligations (mission 3; round-glacier-2865; directory evidence civic-sand-2641).** Directory deletion, residual audit and Measure disable/delete landed; do not redispatch. Broader no-GUI-source wording remains unproved. Material GUI registrations, MeshPart InitGui, mixed helpers/resources and inactive Main launcher branches remain separately bounded obligations; preserve Measure App identity, required Assembly proxies and App tests. Re-rank these after the bounded Help sequence without weakening the exit criterion or replacing publishers. They remain open even while whole-tree qualification leads. [rec: terse-ridge-1619] [rec: humble-shore-1680] [rec: placid-harvest-8845] [rec: small-tide-8341] [rec: quiet-canyon-3950]
3. **Remaining L3 motors and mechanisms (mission 4; rising-banner-4325, brave-stone-9609).** The coverage audit landed with 90 passing existing-payload lifecycle/library tests; four single-SKU families do not close full L3. After reduction resolves or is evidenced blocked, use docs/L3-COVERAGE.md: N20 independent interface probes are the smallest evidence-only unit; additional BLDC delivery first needs a named common-size acceptance set and qualified winding/kV/torque evidence, not just another envelope. Preserve solenoid delivery as open deferred work, restarting only with new revision-matched mounting/travel evidence, a qualified alternative, or a separately justified narrower contract and decision; no repeated identical source searches. Deliveries require provenance, real-worker tests and staging completed before packaged gates. L12 and GE 6 C approximations establish neither installation fit nor physical inertia nor automatic dynamics; L12 is not a conservative collision envelope. Compound gearing stays long. [rec: steady-rain-3009] [rec: open-pine-9349] [rec: morning-field-8202] [rec: silver-sage-7486]
