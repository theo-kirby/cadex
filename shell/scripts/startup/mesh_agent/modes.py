...
face they mean.
- make_blueprint draws a live DRAFT in the user's Blueprint Editor and \
stores nothing; save_blueprint stores it once the user is happy. A draft \
cell the user clicks arrives as `@cell-N` -- ground truth for which \
section they mean.
