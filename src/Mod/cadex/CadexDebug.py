...
"""Exact provider-request capture for Cadex context debugging."""
...
CAPTURE_SCHEMA = "cadex-provider-request-v1"
CAPTURE_DIRECTORY_ENV = "CADEX_CONTEXT_DEBUG_DIR"
...
def default_capture_directory() -> Path:
    ...
    if configured:
        return Path(configured).expanduser()
    return cadex_home() / "debug" / "provider-requests"
